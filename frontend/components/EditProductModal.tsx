...
export const EditProductModal = ({ isOpen, onClose, onEdit, product }: EditProductModalProps) => {
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
                    ...
                    >
                        <div className="flex justify-between items-center p-6 border-b border-zinc-100">
                            <h2 className="text-xl font-semibold text-zinc-900 tracking-tight">Edit Product</h2>
